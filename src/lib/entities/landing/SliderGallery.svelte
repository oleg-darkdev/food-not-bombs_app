				...
				<div style="" role="listitem" class="flex flex-col items-center justify-center">
					...
					<div class="item_img-wrap slider-item rounded-2xl">
						...
						<!-- <video
							...
							muted=""
							loop=""
							class="video_frame lazy full-size"
						>
...
<style lang="postcss">
	...
	.img_floating-element {
		z-index: 35;
		aspect-ratio: 1;
		border: 0.1em solid var(--borders--army-green);
	...
	.ugc_video-gallery.slider-wrapper {
		object-fit: fill;
		padding-top: 0;
		padding-bottom: 0;
	}
