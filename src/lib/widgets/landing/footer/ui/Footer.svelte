...
<footer class="section footer">
	...
	<div class="wrap_footer">
		<div class="wrap_footer-logo">
			<a href="/" class="link_footer-logo w-inline-block">
				...
				<img
					...
					class="img_footer-logo"
				/>
			</a>
			<div class="txt_footer">Готовим для всех нуждающихся до последнего дняпока идут войны.</div>
		</div>
		<!-- wrap_footer-links -->
		<div class="flex flex-row">
			...
			<!-- 				id="w-node-_1072bbd0-9134-708c-95df-818abc896cf3-bc896cec"
 -->
			<ul role="list" class="list_footer-links footer-menu w-list-unstyled">
				{#each groupsByRegion as region}
					<li class="item_footer-links">
						<a href={region.link} class="link_footer" target="_blank">{region.title}</a>
					</li>
				{/each}
			</ul>
		</div>
		...
		<div class="wrap_footer-social-links">
			<ul role="list" class="list_footer-links social w-list-unstyled">
				<li id="w-node-_1072bbd0-9134-708c-95df-818abc896d22-bc896cec" class="item_social-link">
					<a
						href="https://www.instagram.com/pophaus.co/"
						target="_blank"
						class="ico_footer-icon w-inline-block"
					>
						<img
				...
				<li id="w-node-_1072bbd0-9134-708c-95df-818abc896d25-bc896cec" class="item_social-link">
					<a
						href="https://www.linkedin.com/company/pophaus-studio/"
						class="ico_footer-icon w-inline-block"
					>
						<img
				...
				<li id="w-node-_1072bbd0-9134-708c-95df-818abc896d28-bc896cec" class="item_social-link">
					<a
						href="https://www.pinterest.ca/pophauscreative/"
						target="_blank"
						class="ico_footer-icon w-inline-block"
					>
						<img
	...
	<div class="txt_footer foot-notes">
		Development by <a
			href="https://oleg-darkdev.vercel.app/"
			target="_blank"
			class="txt_footer text-pink link">Oleg_DarkDev</a
		>. 2025

		<br />

		An <a href="https://github.com/oleg-darkdev/food-not-bombs_app" class="txt_footer link text-pink" target="_blank">open source project</a> ,
		licensed under
		<a
			href="https://creativecommons.org/licenses/by-nc-sa/4.0/"
			class="txt_footer link text-orange"
...
<style lang="postcss">
.section.footer {
	background-color: var(--borders--army-green);
	padding-bottom: 1em;
}
...
.list_footer-links.social,
.list_footer-links.contact-info {
...
.wrap_footer-contact-info {
	width: 30%;
}

.wrap_footer-social-links {
	width: 5%;
}
