const data = [
	{
		...
		country: 'Estonia',
		city: 'Tallinn',
		sharingAddress: 'Tallinn, , Estonia',
		sharingInfo:
			'The current listed email address bounces. If anyone has information about this chapter, please let us know at map@foodnotbombs.info',
		email: 'videomees@hot.ee',
		website: '',
		videos: [{ title: '', link: '' }],
		twitter: '',
		cookingAddress: '',
