const data = [
	{
		...
		since: '',
		facebook: 'https://www.facebook.com/bombalarakarsisofralar',
		inst: '',
		gallery: [
			[
				{
		...
		photos: '',
		name: 'Bombalara Karşı Sofralar / FNB İzmir',
		country: 'Turkey',
		city: 'İzmir',
		sharingAddress: 'Basmane-İzmir, Turkey',
		sharingInfo: 'Sundays, 2nd and 4th Week of the Month at 5-7pm',
		email: 'bombalarakarsisofralarizmir@gmail.com',
		website: '',
		videos: [{ title: '', link: '' }],
		twitter: '',
		cookingAddress: 'Kapılar, Basmane - İzmir',
		cookingInfo: '',
		contactPhone: '',
		contactName: '',
		emtyDel: '', telegram: '',
	...
	},
	{
		logo: '/images/groups/europe/',
		since: '',
		facebook: 'https://www.facebook.com/sofralar/',
		inst: '',
		gallery: [
			[
				{
		...
		photos: '',
		name: 'FNB / Bombalara Karşı Sofralar Taksim',
		country: 'Turkey',
		city: 'Istanbul',
		sharingAddress: 'Bülbül Mah. Turan cad. 36A Beyoğlu/İstanbul Istanbul, Turkey',
		sharingInfo:
			'Wednesdays 8-9pm. Previously Galatasaray Square, location changes weekly due to police repression.',
		email: 'bombalara-karsi-sofralar@riseup.net',
		website: 'http://foodnotbombs-istanbul.tumblr.com',
		videos: 'https://www.couchsurfing.com/users/2000188339',
		twitter: 'https://twitter.com/FNB_Sofralar',
		cookingAddress: 'Bülbül Mah. Turan cad. 36A Beyoğlu/İstanbul',
		cookingInfo: 'Collecting: 3pm, Cooking 4pm',
		contactPhone: '905336101067',
		contactName: 'Tolga',
		emtyDel: '', telegram: '',
		id: 'sofralar-fnb',
		banner: '',
		...
		facebookChecked: false,
		notes:
			'Savaşı / yoksulluğu körükleyen devletlere, israfa, doğa / hayvan sömürüsüne ve tüketim k?',
		shortDesc: [''],
		fullDesc: ['']
	}
];
