const data = [
	{
		...
		since: '',
		facebook: 'https://www.facebook.com/fnbtbilisi?ref=ts&fref=ts',
		inst: '',
		gallery: [
			[
				{
		...
		country: 'Georgia',
		city: 'Tbilisi',
		sharingAddress: 'Vere park',
		sharingInfo: 'Most Saturdays at 12:30',
		email: 'caucasus.social.forum@gmail.com',
		website: '',
		videos: [{ title: '', link: '' }],
		twitter: '',
		cookingAddress: '',
