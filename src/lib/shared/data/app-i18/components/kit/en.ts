	...
	tokens: {
		...
		players: {
			...
			items: [
				...
				{ img: '/images/kit/tokens/players/scout_token_promo.svg', title: 'Scout', quantity: 12 },
				{ img: '/images/kit/tokens/players/coach_token_promo.svg', title: 'Coach', quantity: 14 },
				{ img: '/images/kit/tokens/players/cook_token_promo.svg', title: 'Cook', quantity: 12 }
			]
		},
		food: {
